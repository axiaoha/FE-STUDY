...
const { effect, reactive, shallowReactive, ref, shallowReadonly, proxyRefs } =
  VueReactivity;
...
const MyComponent = {
  ...
  setup(props, setupContext) {
    console.log("setup", props, setupContext);
...
setTimeout(() => {
  count.value = 1;
  // CompVNode.component.state.count = 1;
  // CompVNode.component.props.title = "new props title";
  // renderer.render(CompVNode, document.querySelector("#app"));
}, 1000);
